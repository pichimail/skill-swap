...
export default function Footer() {
  return (
    <footer className="w-full py-10 relative z-10 border-t border-slate-200/50 bg-[#f4f7fb]/50">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-semibold text-slate-900">SkillSwap</span>
            </div>
            <p className="text-xs text-slate-500">© {new Date().getFullYear()} SkillSwap, Inc. All rights reserved.</p>
            <p className="text-xs text-slate-400">
              Built by <span className="font-medium text-slate-600">Gnaneshwar Raavi</span>
            </p>
          </div>
          <div className="flex items-center gap-4">
            <Link
              href="https://github.com/gnaneshwarraavi"
              target="_blank"
            ...
            <Link
              href="https://instagram.com/gnanu4611"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
            >
